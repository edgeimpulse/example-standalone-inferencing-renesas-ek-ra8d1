...
#define BSP_FEATURE_ADC_ADDITION_SUPPORTED                   (1U) // ADC Derived from RA6M5
...
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS                      (0x7F0077) // 0 to 2, 4 to 6, 16 to 22
...
#define BSP_FEATURE_BSP_NONSECURE_ADDRESS_OFFSET             (0x10000000U)
...
#define BSP_FEATURE_BSP_HAS_OFS3                             (1U)
...
#define BSP_FEATURE_BSP_HAS_USBHS_CLOCK                      (1)
...
#define BSP_FEATURE_CGC_PLLCCR_MAX_HZ                        (480000000U)
...
#define BSP_FEATURE_ICU_WUPEN_MASK                           (0xFF1DFFFFU) // Note there is another WUPEN1 register
#define BSP_FEATURE_ICU_HAS_INTERRUPT_GROUPS                 (0U)

#define BSP_FEATURE_IIC_FAST_MODE_PLUS                       (0x01)
#define BSP_FEATURE_IIC_VALID_CHANNEL_MASK                   (0x03)
#define BSP_FEATURE_IIC_VERSION                              (1)
#define BSP_FEATURE_IIC_BUS_FREE_TIME_MULTIPLIER             (5U) // TODO JDG - Evaluate
