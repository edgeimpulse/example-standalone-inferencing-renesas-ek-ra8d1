...
// TODO JDG - This file was added for IIC, other event ids not evaluated
typedef enum e_elc_event_ra8d1
{
    ...
    ELC_EVENT_DTC_END                 = (0x023), // DTC transfer end
    ...
    ELC_EVENT_ULPT0_ULPTI             = (0x040), // ULPT0 Underflow
    ELC_EVENT_ULPT0_ULPTCMAI          = (0x041), // ULPT0 Compare match A
    ELC_EVENT_ULPT0_ULPTCMBI          = (0x042), // ULPT0 Compare match B
    ELC_EVENT_ULPT1_ULPTI             = (0x043), // ULPT1 Underflow
    ELC_EVENT_ULPT1_ULPTCMAI          = (0x044), // ULPT1 Compare match A
    ELC_EVENT_ULPT1_ULPTCMBI          = (0x045), // ULPT1 Compare match AB
    ...
    ELC_EVENT_GPT4_PC                 = (0x0CD), // Period count function finish
    ...
    ELC_EVENT_GPT5_PC                 = (0x0D6), // Period count function finish
    ...
    ELC_EVENT_GPT6_PC                 = (0x0DF), // Period count function finish
    ...
    ELC_EVENT_GPT7_PC                 = (0x0E8), // Period count function finish
    ...
    ELC_EVENT_GPT11_PC                = (0x10C), // Period count function finish
    ...
    ELC_EVENT_CAN_DMAREQ0             = (0x187), // DMA 0 request
    ELC_EVENT_CAN_DMAREQ1             = (0x188), // DMA 1 request
    ELC_EVENT_CAN_DMAREQ4             = (0x18B), // DMA 4 request
    ELC_EVENT_CAN_DMAREQ5             = (0x18C), // DMA 5 request
    ...
    ELC_CAN0_MRAM_ERI                 = (0x19B), // CANFD0 ECC error
    ELC_CAN1_MRAM_ERI                 = (0x19C), // CANFD1 ECC error
