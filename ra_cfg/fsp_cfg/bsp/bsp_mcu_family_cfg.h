...
#define BSP_CFG_ROM_REG_OFS2 ((1 << 0) | (1 << 1) | 0xFFFFFFFCU)
...
#define BSP_CFG_ROM_REG_OFS1 (0xFCF0FED0 | (1 << 3) | (7) | (1 << 5) |  (1 << 8) | (0 << 16) | (0 << 17) | (0 << 18) | (0 << 19) | (0 << 24) | (1 << 25))

/* Option Function Select Register 3 Security Attribution */
#ifndef BSP_CFG_ROM_REG_OFS3_SEL
#if defined(_RA_TZ_SECURE) || defined(_RA_TZ_NONSECURE)
            #define BSP_CFG_ROM_REG_OFS3_SEL ((RA_NOT_DEFINED > 0) ? 0xA001FFFFU : 0xFFFFFFFFU)
 #else
#define BSP_CFG_ROM_REG_OFS3_SEL (0xA001FFFFU)
#endif
#endif

#define OFS_SEQ6 0xA001FFFF | (1 << 17)
#define OFS_SEQ7 (3 << 18) |(15 << 20) | (3 << 24) | (3 << 26)
#define OFS_SEQ8 (1 << 28) | (1 << 30)
#define BSP_CFG_ROM_REG_OFS3 (OFS_SEQ6 | OFS_SEQ7 | OFS_SEQ8)
