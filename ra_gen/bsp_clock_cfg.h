...
#define BSP_CFG_PLL1Q_FREQUENCY_HZ (160000000) /* PLL1Q 160000000Hz */
#define BSP_CFG_PLODIVR (BSP_CLOCKS_PLL_DIV_6) /* PLL1R Div /6 */
#define BSP_CFG_PLL1R_FREQUENCY_HZ (160000000) /* PLL1R 160000000Hz */
...
#define BSP_CFG_PLL2_MUL BSP_CLOCKS_PLL_MUL(26,0) /* PLL2 Mul x26-39|Mul x26|PLL2 Mul x26.00 */
...
#define BSP_CFG_PL2ODIVR (BSP_CLOCKS_PLL_DIV_6) /* PLL2R Div /6 */
...
#define BSP_CFG_UHSCK_SOURCE (BSP_CLOCKS_CLOCK_DISABLED) /* UHSCK Disabled */
...
#define BSP_CFG_SPICLK_DIV (BSP_CLOCKS_SPI_CLOCK_DIV_2) /* SPICLK Div /2 */
...
#define BSP_CFG_ADCCLK_DIV (BSP_CLOCKS_ADC_CLOCK_DIV_1) /* ADCCLK Div /1 */
...
#define BSP_CFG_UHSCK_DIV (BSP_CLOCKS_USB_CLOCK_DIV_5) /* UHSCK Div /5 */
